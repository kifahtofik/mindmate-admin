...
const mockEngagementData = [
  { date: 'Mon', sessions: 145, exercises: 89 },
  { date: 'Tue', sessions: 167, exercises: 102 },
  { date: 'Wed', sessions: 134, exercises: 78 },
  { date: 'Thu', sessions: 189, exercises: 124 },
  { date: 'Fri', sessions: 201, exercises: 145 },
  { date: 'Sat', sessions: 176, exercises: 98 },
  { date: 'Sun', sessions: 156, exercises: 87 },
];

const mockAlerts = [
  { id: 1, type: 'high', message: 'User flagged for crisis keywords in journal entry', time: '5 min ago', userId: 'u_456' },
  { id: 2, type: 'medium', message: 'Unusual activity pattern detected', time: '23 min ago', userId: 'u_789' },
];
    ...
    <Box sx={{ 
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="flex-end" sx={{ mb: 5 }}>
        <Box>
          ...
          <Typography sx={{ color: '#64748b', fontSize: '1.1rem', mt: 0.5 }}>
            Real-time platform health & user safety monitoring
          </Typography>
        </Box>
      </Stack>
